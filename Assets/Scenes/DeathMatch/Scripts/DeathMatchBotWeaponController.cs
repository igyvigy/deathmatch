...
{
    public class DeathMatchBotWeaponController : MonoBehaviour
    {
        DeathMatchBotController botController;
        ...
        public IEnumerator _UnSheathWeapon(int weaponNumber)
        {
            ...
            botController.SetWeaponState(weaponNumber);
            yield return null;
        }
        ...
        public IEnumerator _SheathWeapon(int weaponNumber, int weaponTo)
        {
            ...
            botController.SetWeaponState(weaponTo);
            yield return null;
        }
        ...
        void DoWeaponSwitch(int weaponSwitch, int weaponVisibility, int weaponNumber, int leftRight, bool sheath)
        {
            ...
            if (weaponSwitch < 1)
            {
                if (Is2HandedWeapon(weaponNumber))
                {
                    botController.Lock(true, true, true, 0f, 1f);
                }
            }
            ...
            if (sheath)
            {
                ...
                if (botController.ikHands != null)
                {
                    StartCoroutine(botController.ikHands._BlendIK(false, 0f, 0.2f, weaponVisibility));
                }
            }
            else
            {
                ...
                if (botController.ikHands != null)
                {
                    StartCoroutine(botController.ikHands._BlendIK(true, 0.5f, 1, weaponVisibility));
                }
            }
        }
        ...
        public IEnumerator _HideAllWeapons(bool timed, bool resetToUnarmed)
        {
            ...
            if (resetToUnarmed)
            {
                ...
                StartCoroutine(botController.weaponController._WeaponVisibility(botController.weaponController.leftWeapon, false, true));
        ...
        void SetAnimator(int weapon, int weaponSwitch, int Lweapon, int Rweapon, int weaponSide)
        {
            ...
            botController.SetWeaponState(weapon);
        }
